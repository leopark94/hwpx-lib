...
describe("SectionProperties", () => {
    describe("#constructor()", () => {
        ...
        it("should create section properties with changed options", () => {
            ...
            expect(tree["hp:sectPr"][1]).to.deep.equal({
                "hs:pageMargin": {
                    _attr: Object.assign(Object.assign({}, DEFAULT_MARGINS), { "hp:top": 0 }),
                },
            });
        });
        it("should create section properties with changed options", () => {
            ...
            expect(tree["hp:sectPr"][1]).to.deep.equal({
                "hs:pageMargin": {
                    _attr: Object.assign(Object.assign({}, DEFAULT_MARGINS), { "hp:bottom": 0 }),
                },
            });
        });
        it("should create section properties with changed options", () => {
        ...
        it("should create section properties with page borders", () => {
            ...
            const tree = new Formatter().format(properties);
            expect(Object.keys(tree)).to.deep.equal(["hs:sectPr"]);
            const pgBorders = tree["hp:sectPr"].find((item) => item["w:pgBorders"] !== undefined);
        ...
        it("should create section properties with page number type, but without start attribute", () => {
            ...
            const tree = new Formatter().format(properties);
            expect(Object.keys(tree)).to.deep.equal(["hs:sectPr"]);
            const pgNumType = tree["hp:sectPr"].find((item) => item["hs:pageNumbers"] !== undefined);
        ...
        it("should create section properties with section type", () => {
            ...
            const tree = new Formatter().format(properties);
            expect(Object.keys(tree)).to.deep.equal(["hs:sectPr"]);
            const type = tree["hp:sectPr"].find((item) => item["hp:type"] !== undefined);
        ...
        it("should create section properties line number type", () => {
            ...
            const tree = new Formatter().format(properties);
            expect(Object.keys(tree)).to.deep.equal(["hs:sectPr"]);
            const type = tree["hp:sectPr"].find((item) => item["w:lnNumType"] !== undefined);
            expect(type).to.deep.equal({
        ...
        it("should create section properties with text flow direction", () => {
            ...
            const tree = new Formatter().format(properties);
            expect(Object.keys(tree)).to.deep.equal(["hs:sectPr"]);
            const type = tree["hp:sectPr"].find((item) => item["hs:textDirection"] !== undefined);
            expect(type).to.deep.equal({
