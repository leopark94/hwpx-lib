...
describe("ImageRun", () => {
    describe("#constructor()", () => {
                                                                ...
                                                                "pic:blipFill": [
                                                                    {
                                                                        "a:blip": {
                                                                            _attr: {
                                                                                cstate: "none",
                                                                                "r:embed": "rId{da39a3ee5e6b4b0d3255bfef95601890afd80709.png}",
                                                                            },
                                                                        },
                                                                    },
                                                                    {
                                                                                            ...
                                                                                            },
                                                                                            {
                                                                                                "asvg:svgBlip": {
                                                                                                    _attr: expect.objectContaining({
                                                                                                        "r:embed": "rId{da39a3ee5e6b4b0d3255bfef95601890afd80709.svg}",
                                                                                                    }),
                                                                                                },
                                                                                            },
                                                                                        ],
        ...
        it("using same data twice should use same media key", () => {
            ...
            expect(addImageSpy).toHaveBeenNthCalledWith(1, `${expectedHash}.png`, expect.objectContaining({ fileName: `${expectedHash}.png` }));
            expect(addImageSpy).toHaveBeenNthCalledWith(2, `${expectedHash}.png`, expect.objectContaining({ fileName: `${expectedHash}.png` }));
        });
    });
});
//# sourceMappingURL=image-run.spec.js.map