    ...
    describe("#constructor()", () => {
        it("uses the font name for both ascii and hAnsi", () => {
            ...
            expect(tree).to.deep.equal({
                "hp:rFonts": { _attr: { "w:ascii": "Times", "w:cs": "Times", "hp:eastAsia": "Times", "w:hAnsi": "Times" } },
            });
        });
        it("uses hint if given", () => {
            ...
            expect(tree).to.deep.equal({
                "hp:rFonts": {
                    _attr: { "w:ascii": "Times", "w:cs": "Times", "hp:eastAsia": "Times", "w:hAnsi": "Times", "w:hint": "default" },
                },
            });
        });
        it("uses the font attrs for ascii and eastAsia", () => {
            ...
            expect(tree).to.deep.equal({
                "hp:rFonts": { _attr: { "w:ascii": "Times", "hp:eastAsia": "KaiTi" } },
            });
        });
    });
});
