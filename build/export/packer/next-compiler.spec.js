...
describe("Compiler", () => {
    ...
    describe("#compile()", () => {
        ...
        it("should pack subfile overrides", () => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const file = new File({
                sections: [],
                comments: {
            ...
            const commentsText = yield ((_a = zipFile.file("word/comments.xml")) === null || _a === void 0 ? void 0 : _a.async("text"));
            const commentsExtendedText = yield ((_b = zipFile.file("word/commentsExtended.xml")) === null || _b === void 0 ? void 0 : _b.async("text"));
