...
describe("from-docx", () => {
    describe("patchDocument", () => {
        describe("document.xml and [Content_Types].xml", () => {
            ...
            it("should patch the document", () => __awaiter(void 0, void 0, void 0, function* () {
                const output = yield patchDocument({
            ...
            it("should work with the raw JSZip type", () => __awaiter(void 0, void 0, void 0, function* () {
                const zip = new JSZip();
                zip.file("word/document.xml", MOCK_XML);
                zip.file("[Content_Types].xml", `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>`);
                const output = yield patchDocument({
            ...
            it("should skiup UTF-16 types", () => __awaiter(void 0, void 0, void 0, function* () {
                const zip = new JSZip();
                zip.file("word/document.xml", MOCK_XML);
            ...
            it("throws error with empty delimiters", () => __awaiter(void 0, void 0, void 0, function* () {
                yield expect(() => patchDocument({
                    outputType: "uint8array",
                    data: Buffer.from(""),
                    patches: {},
                    placeholderDelimiters: { start: "", end: "" },
            ...
            it("throws error with whitespace-only delimiters", () => __awaiter(void 0, void 0, void 0, function* () {
                yield expect(() => patchDocument({
                    outputType: "uint8array",
                    data: Buffer.from(""),
                    patches: {},
        ...
        describe("document.xml and [Content_Types].xml with relationships", () => {
            beforeEach(() => {
                vi.spyOn(JSZip, "loadAsync").mockReturnValue(new Promise((resolve) => {
                    const zip = new JSZip();
                    zip.file("word/document.xml", MOCK_XML);
            ...
            it("should use the relationships file rather than create one", () => __awaiter(void 0, void 0, void 0, function* () {
                const output = yield patchDocument({
                    outputType: "uint8array",
                    data: Buffer.from(""),
                    patches: {
        ...
        describe("document.xml", () => {
            ...
            it("should throw an error if the content types is not found", () => expect(patchDocument({
                outputType: "uint8array",
                data: Buffer.from(""),
                patches: {
                    image_test: {
...
//# sourceMappingURL=from-docx.spec.js.map