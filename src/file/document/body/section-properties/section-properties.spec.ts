...
describe("SectionProperties", () => {
    describe("#constructor()", () => {
        it("should create section properties with options", () => {
            ...
            expect(tree["hp:sectPr"][0]).to.deep.equal({ "w:headerReference": { _attr: { "r:id": "rId100", "hp:type": "default" } } });
            expect(tree["hp:sectPr"][1]).to.deep.equal({ "w:footerReference": { _attr: { "r:id": "rId200", "hp:type": "even" } } });
