...
describe("Columns", () => {
    describe("#constructor()", () => {
        it("should create columns of equal width if equalWidth is true", () => {
            ...
            expect(tree["hp:cols"]).to.deep.equal({ _attr: { "w:num": 3, "hp:space": 720 } });
        });
        ...
        it("should create set space and count to undefined if they are undefined", () => {
            ...
            expect(tree["hp:cols"]).to.deep.equal({ _attr: {} });
        });
        ...
        it("should ignore individual column attributes if equalWidth is true", () => {
            ...
            expect(tree).to.deep.equal({ "w:cols": { _attr: { "w:num": 3, "hp:space": 720, "w:equalWidth": true } } });
        });
        ...
        it("should have column children if equalWidth is false and individual columns are provided", () => {
            ...
            expect(tree).to.deep.equal({
                "w:cols": [
                    { _attr: { "w:num": 3, "hp:space": 720, "w:equalWidth": false } },
                    { "w:col": { _attr: { "hp:space": 400, "hp:w": 1000 } } },
                    { "w:col": { _attr: { "hp:w": 2000 } } },
                ],
            });
        });
    });
