...
import { Document, HeadingLevel, Packer, Paragraph, TextRun } from "hwpx";
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("demo/53-chinese.hwpx", buffer);
    console.log("✅ HWPX 파일 생성 완료: demo/53-chinese.hwpx");
});
