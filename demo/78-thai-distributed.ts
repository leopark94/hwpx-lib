...
import { AlignmentType, Document, Packer, Paragraph, TextRun } from "hwpx";
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("demo/78-thai-distributed.hwpx", buffer);
    console.log("✅ HWPX 파일 생성 완료: demo/78-thai-distributed.hwpx");
});
