...
import { Document, ImageRun, Packer, Paragraph, TextWrappingSide, TextWrappingType } from "hwpx";
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("demo/38-text-wrapping.hwpx", buffer);
    console.log("✅ HWPX 파일 생성 완료: demo/38-text-wrapping.hwpx");
});
