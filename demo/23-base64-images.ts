...
import { Document, ImageRun, Packer, Paragraph, TextRun } from "hwpx";
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("demo/23-base64-images.hwpx", buffer);
    console.log("✅ HWPX 파일 생성 완료: demo/23-base64-images.hwpx");
});
