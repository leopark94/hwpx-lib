...
import { Document, Footer, Header, Packer, PageNumber, NumberFormat, PageOrientation, Paragraph, TextRun } from "hwpx";
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("demo/16-multiple-sections.hwpx", buffer);
    console.log("✅ HWPX 파일 생성 완료: demo/16-multiple-sections.hwpx");
});
